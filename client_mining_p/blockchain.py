...
# Change the method to accept a POST request
@app.route('/mine', methods=['POST'])
def mine():
    # Determine if proof is valid
    last_block = blockchain.last_block
    last_proof = last_block['proof']
    # Get rid of line below b/c 'proof_of_work' was commented out above
...
# Endpoint that returns proof of the last block
...
# Python interpreter reads this source file and runs it.
if __name__ == '__main__':
    if len(sys.argv) > 1:
        port = int(sys.argv[1])
    else:
